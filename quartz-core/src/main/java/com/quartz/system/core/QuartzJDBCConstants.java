...
/*
    ...
    String UPDATE_TRIGGER_STATES_FROM_OTHER_STATES = "UPDATE "
            ...
            + COL_TRIGGER_STATE
            + " = ? OR "
            + COL_TRIGGER_STATE + " = ? ) AND " + SCHED_NAME_CONDITION;
    ...
    String UPDATE_TRIGGER_STATE_FROM_OTHER_STATES_BEFORE_TIME = "UPDATE "
            ...
            + COL_TRIGGER_STATE
            + " = ? OR "
            + COL_TRIGGER_STATE + " = ?) AND " + COL_NEXT_FIRE_TIME + " < ? AND " + SCHED_NAME_CONDITION;

    String SELECT_MISFIRED_TRIGGERS = "SELECT * FROM "
            + TABLE_PREFIX_SUBST + TABLE_TRIGGERS + " WHERE "
            + COL_NEXT_FIRE_TIME + " < ? AND " + SCHED_NAME_CONDITION
    ...
    String SELECT_MISFIRED_TRIGGERS_IN_STATE = "SELECT "
            + COL_TRIGGER_NAME + ", " + COL_TRIGGER_GROUP + " FROM "
            + TABLE_PREFIX_SUBST + TABLE_TRIGGERS + " WHERE "
            + COL_NEXT_FIRE_TIME + " < ? AND " + COL_TRIGGER_STATE + " = ? AND " + SCHED_NAME_CONDITION
            + "ORDER BY "+ COL_NEXT_FIRE_TIME + " ASC, " + COL_PRIORITY + " DESC";
    ...
    String COUNT_MISFIRED_TRIGGERS_IN_STATES = "SELECT COUNT("
            ...
            + TABLE_PREFIX_SUBST + TABLE_TRIGGERS + " WHERE "
            + COL_NEXT_FIRE_TIME + " < ? "
            + "AND ((" + COL_TRIGGER_STATE + " = ?) OR (" + COL_TRIGGER_STATE + " = ?)) AND " + SCHED_NAME_CONDITION;
    ...
    String SELECT_MISFIRED_TRIGGERS_IN_GROUP_IN_STATE = "SELECT "
            ...
            + " < ? AND "
            + COL_TRIGGER_GROUP
            + " = ? AND " + COL_TRIGGER_STATE + " = ? AND " + SCHED_NAME_CONDITION
            + "ORDER BY "+ COL_NEXT_FIRE_TIME + " ASC, " + COL_PRIORITY + " DESC";
    ...
    String DELETE_FIRED_TRIGGERS = "DELETE FROM "
            + TABLE_PREFIX_SUBST + TABLE_FIRED_TRIGGERS + " WHERE " + SCHED_NAME_CONDITION;
    ...
    String INSERT_JOB_DETAIL = "INSERT INTO "
            ...
            + COL_JOB_DATAMAP + ",  " + COL_SCHED_NAME + ") " + " VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, {1})";
    ...
    String UPDATE_JOB_DETAIL = "UPDATE "
            ...
            + " = ? AND " + COL_JOB_GROUP + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String SELECT_STATEFUL_JOBS_OF_TRIGGER_GROUP = "SELECT DISTINCT J."
            ...
            + COL_JOB_GROUP
            + " AND J."
            + COL_IS_STATEFUL + " = ? " + " AND T." + COL_SCHED_NAME + " = J." + COL_SCHED_NAME + " AND T." + SCHED_NAME_CONDITION;

    String DELETE_JOB_LISTENERS = "DELETE FROM "
            + TABLE_PREFIX_SUBST + TABLE_JOB_LISTENERS + " WHERE "
            + COL_JOB_NAME + " = ? AND " + COL_JOB_GROUP + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String SELECT_JOB_STATEFUL = "SELECT "
            ...
            + COL_JOB_GROUP + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String SELECT_VOLATILE_JOBS = "SELECT " + COL_JOB_NAME
            + ", " + COL_JOB_GROUP + " FROM " + TABLE_PREFIX_SUBST
            + TABLE_JOB_DETAILS + " WHERE " + COL_IS_VOLATILE + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String INSERT_TRIGGER = "INSERT INTO "
            ...
            + ", " + COL_MISFIRE_INSTRUCTION + ", " + COL_JOB_DATAMAP + ", " + COL_PRIORITY + " , " + COL_SCHED_NAME + ") "
            + " VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, {1})";
    ...
    String INSERT_SIMPLE_TRIGGER = "INSERT INTO "
            ...
            + COL_TIMES_TRIGGERED + ", " + COL_SCHED_NAME + ") " + " VALUES(?, ?, ?, ?, ?, {1})";

    String INSERT_CRON_TRIGGER = "INSERT INTO "
            + TABLE_PREFIX_SUBST + TABLE_CRON_TRIGGERS + " ("
            + COL_TRIGGER_NAME + ", " + COL_TRIGGER_GROUP + ", "
            + COL_CRON_EXPRESSION + ", " + COL_TIME_ZONE_ID + ", " + COL_SCHED_NAME + ") "
            + " VALUES(?, ?, ?, ?, {1})";
    ...
    String UPDATE_TRIGGER_SKIP_DATA = "UPDATE " + TABLE_PREFIX_SUBST
            ...
            + " = ? AND " + COL_TRIGGER_GROUP + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String UPDATE_TRIGGER = "UPDATE " + TABLE_PREFIX_SUBST
            ...
            + COL_TRIGGER_NAME + " = ? AND " + COL_TRIGGER_GROUP + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String UPDATE_BLOB_TRIGGER = "UPDATE "
            ...
            + COL_TRIGGER_GROUP + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String UPDATE_TRIGGER_STATE_FROM_STATE = "UPDATE "
            + TABLE_PREFIX_SUBST + TABLE_TRIGGERS + " SET " + COL_TRIGGER_STATE
            + " = ?" + " WHERE " + COL_TRIGGER_NAME + " = ? AND "
            + COL_TRIGGER_GROUP + " = ? AND " + COL_TRIGGER_STATE + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String UPDATE_TRIGGER_STATE_FROM_STATES = "UPDATE "
            ...
            + COL_TRIGGER_STATE + " = ? OR " + COL_TRIGGER_STATE + " = ?) AND " + SCHED_NAME_CONDITION;
    ...
    String INSERT_TRIGGER_LISTENER = "INSERT INTO "
            ...
            + COL_TRIGGER_NAME + ", " + COL_TRIGGER_GROUP + ", "
            + COL_TRIGGER_LISTENER + ", " + COL_SCHED_NAME + ") VALUES(?, ?, ?, {1})";
    ...
    String SELECT_NUM_TRIGGERS = "SELECT COUNT("
            + COL_TRIGGER_NAME + ") " + " FROM " + TABLE_PREFIX_SUBST
            + TABLE_TRIGGERS + " WHERE " + SCHED_NAME_CONDITION;

    String SELECT_NUM_TRIGGERS_IN_GROUP = "SELECT COUNT("
            + COL_TRIGGER_NAME + ") " + " FROM " + TABLE_PREFIX_SUBST
            + TABLE_TRIGGERS + " WHERE " + COL_TRIGGER_GROUP + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String SELECT_REFERENCED_CALENDAR = "SELECT "
            + COL_CALENDAR_NAME + " FROM " + TABLE_PREFIX_SUBST
            + TABLE_TRIGGERS + " WHERE " + COL_CALENDAR_NAME + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String SELECT_NUM_CALENDARS = "SELECT COUNT("
            + COL_CALENDAR_NAME + ") " + " FROM " + TABLE_PREFIX_SUBST
            + TABLE_CALENDARS + " WHERE " + SCHED_NAME_CONDITION;

    String SELECT_CALENDARS = "SELECT " + COL_CALENDAR_NAME
            + " FROM " + TABLE_PREFIX_SUBST + TABLE_CALENDARS + " WHERE " + SCHED_NAME_CONDITION;
    ...
    String SELECT_NEXT_FIRE_TIME = "SELECT MIN("
            ...
            + COL_TRIGGER_STATE + " = ? AND " + COL_NEXT_FIRE_TIME + " >= 0 AND " + SCHED_NAME_CONDITION;
    ...
    String SELECT_NEXT_TRIGGER_TO_ACQUIRE = "SELECT "
            ...
            + "AND (" + COL_NEXT_FIRE_TIME + " >= ?) AND " + SCHED_NAME_CONDITION
            + "ORDER BY "+ COL_NEXT_FIRE_TIME + " ASC, " + COL_PRIORITY + " DESC";
    ...
    String UPDATE_INSTANCES_FIRED_TRIGGER_STATE = "UPDATE "
            ...
            + COL_INSTANCE_NAME + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String SELECT_INSTANCES_RECOVERABLE_FIRED_TRIGGERS = "SELECT * FROM "
            ...
            + TABLE_FIRED_TRIGGERS
            + " WHERE "
            + COL_INSTANCE_NAME + " = ? AND " + COL_REQUESTS_RECOVERY + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String DELETE_FIRED_TRIGGER = "DELETE FROM "
            + TABLE_PREFIX_SUBST + TABLE_FIRED_TRIGGERS + " WHERE "
            + COL_ENTRY_ID + " = ? AND " + SCHED_NAME_CONDITION;
    ...
    String SELECT_SCHEDULER_STATES = "SELECT * FROM "
            + TABLE_PREFIX_SUBST + TABLE_SCHEDULER_STATE + " WHERE " + SCHED_NAME_CONDITION;
    ...
    String INSERT_PAUSED_TRIGGER_GROUP = "INSERT INTO "
            ...
            + COL_TRIGGER_GROUP + ", " + COL_SCHED_NAME + ") VALUES(?, {1})";

    String SELECT_PAUSED_TRIGGER_GROUP = "SELECT "
            + COL_TRIGGER_GROUP + " FROM " + TABLE_PREFIX_SUBST
            + TABLE_PAUSED_TRIGGERS + " WHERE " + COL_TRIGGER_GROUP + " = ? AND " + SCHED_NAME_CONDITION;

    String SELECT_PAUSED_TRIGGER_GROUPS = "SELECT "
            + COL_TRIGGER_GROUP + " FROM " + TABLE_PREFIX_SUBST
            + TABLE_PAUSED_TRIGGERS + " WHERE " + SCHED_NAME_CONDITION;
    ...
    String DELETE_PAUSED_TRIGGER_GROUPS = "DELETE FROM "
            + TABLE_PREFIX_SUBST + TABLE_PAUSED_TRIGGERS + " WHERE " + SCHED_NAME_CONDITION;
