...
public class MethodInvokingJobDetailFactoryBean implements FactoryBean,
	...
	protected Log logger = LogFactory.getLog(MethodInvokingJobDetailFactoryBean.class);
	...
	public void afterPropertiesSet() throws Exception {
		try {
			...
			jobDetail.setJobClass(concurrent ? jobClass
			...
			logger.debug("Created JobDetail: " + jobDetail + "; targetClass: "
